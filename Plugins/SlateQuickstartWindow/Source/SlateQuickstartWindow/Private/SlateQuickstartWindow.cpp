...
void FSlateQuickstartWindowModule::StartupModule()
{
	...
	FGlobalTabmanager::Get()->RegisterNomadTabSpawner(SlateQuickstartWindowTabName,
	                                                  FOnSpawnTab::CreateRaw(
		                                                  this, &FSlateQuickstartWindowModule::OnSpawnPluginTab))
		...
		UToolMenu* ToolbarMenu = UToolMenus::Get()->ExtendMenu("LevelEditor.LevelEditorToolBar");
		{
			FToolMenuSection& Section = ToolbarMenu->FindOrAddSection("Settings");
			{
				FToolMenuEntry& Entry = Section.AddEntry(
					FToolMenuEntry::InitToolBarButton(FSlateQuickstartWindowCommands::Get().OpenPluginWindow));
